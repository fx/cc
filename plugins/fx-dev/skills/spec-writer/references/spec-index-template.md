...
**This section applies ONLY when `.duvet/` exists at the repository root.** Every other section of the template is unchanged; projects without `.duvet/` use the `## Requirements` shape shown above exactly as written.
