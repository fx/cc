...
5. Stop after one latest-delta pass leaves no blocking finding unresolved — including any carried from an earlier pass — and every required reviewer thread is settled. Blocking is defined in `references/scope-contract.md` § Blocking.
