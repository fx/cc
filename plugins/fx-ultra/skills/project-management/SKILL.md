...
1. Load the GitHub skill (`Skill tool: skill="fx-ultra:github"`) if using GitHub
...
### Development Skills
- **`fx-ultra:coder`** — Implement features, fix bugs
- **`fx-ultra:planner`** — Create detailed implementation plans
- **`fx-ultra:pr-preparer`** — Prepare and create pull requests
- **`fx-ultra:dev`** — Orchestrate complete SDLC workflow
...
1. **Invoke the setup skill:**
   ```
   Skill tool: skill="fx-ultra:setup"
   ```
