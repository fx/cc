...
**CRITICAL: Load the `fx-ultra:github` skill FIRST** before running any GitHub API operations. This skill provides essential patterns and error handling for `gh` CLI commands.
...
**Invocation:** Use the Skill tool with `skill="fx-ultra:copilot-feedback-resolver"`
...
1. **Load the `fx-ultra:project-management` skill** to track the follow-up work
